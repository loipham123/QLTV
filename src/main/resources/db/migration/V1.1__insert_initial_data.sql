-- V1.1__insert_initial_data.sql

-- -----------------------------------------------------
-- A. CHÈN DỮ LIỆU ROLE (3000...)
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- B. CHÈN DỮ LIỆU USER & TÀI KHOẢN GỐC (4000...)
-- Ghi chú: Sử dụng giá trị chuỗi (hashed) cho mật khẩu.
--          Ví dụ: Mật khẩu là '123456'
-- -----------------------------------------------------

-- 1. ADMIN
INSERT INTO user (id, email, password, full_name, phone, status, created_at, is_deleted) VALUES
    ('40000000-0000-0000-0000-000000000001', 'phuocloi100204@gmail.com', '$2a$10$HASHED_ADMIN_PASSWORD', 'Quản Trị Viên', '0901000001', 'ACTIVE', NOW(), 0);
INSERT INTO user_role (user_id, role_id) VALUES
    ('40000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001');

-- 2. STAFF (Thủ thư)
INSERT INTO user (id, email, password, full_name, phone, status, created_at, is_deleted) VALUES
    ('40000000-0000-0000-0000-000000000002', 'staff@dut.udn.vn', '$2a$10$HASHED_STAFF_PASSWORD', 'Nguyễn Thị A', '0901000002', 'ACTIVE', NOW(), 0);
INSERT INTO user_role (user_id, role_id) VALUES
...
INSERT INTO staff (id, user_id, staff_code, status, created_at, is_deleted) VALUES
    ('50000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000002', 'LIB-001', 'ACTIVE', NOW(), 0);
...
-- -----------------------------------------------------
-- C. CHÈN DỮ LIỆU ĐẦU SÁCH MẪU (1000...)
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- D. CHÈN DỮ LIỆU BẢN IN SÁCH MẪU (1100...)
-- -----------------------------------------------------
